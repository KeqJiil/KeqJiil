...
I like systems that are honest about their trade-offs, and I try to build the same way — no pattern for the sake of using a pattern.
...
![MassTransit](https://img.shields.io/badge/-MassTransit-2E8B57?style=flat-square)
